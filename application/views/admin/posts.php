    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="block-header">
                <h2>
                    IMAGE GALLERY
                    <small>Taken from <a href="https://jsonplaceholder.typicode.com/photos" target="_blank">sachinchoolur.github.io/lightGallery</a></small>
                </h2>
            </div>
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                GALLERY
                                <small>All pictures taken from <a href="https://jasonplaceholder.typicode.com/photos" target="_blank">jasonplaceholder.com</a></small>
                            </h2>
