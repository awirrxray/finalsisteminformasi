...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">Muhammad Musyawir<b> FT - UH </b></a>
                ...
                <form id="sign_in" method="POST" action="<?php echo site_url().'/Admin/loginAction'?>">
                    ...
                    <div class="row">
                        <div class="col-xs-8 p-t-5">
                            ...
                            <label for="rememberme">Ingatka'</label>
                        </div>
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-pink waves-effect" id="button_sign_in" type="submit">MASUK</button>
                        </div>
                    </div>
                    <div class="row m-t-15 m-b--20">
                        <div class="col-xs-6">
                            <a href="sign-up.html">Registrasi Sekarang!</a>
                        </div>
